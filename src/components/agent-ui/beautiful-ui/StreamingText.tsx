...
export default function StreamingText(
  props: NonNullable<Parameters<typeof StreamingTextPreview>[0]> & {
  ...
  if (props.children !== undefined)
    return (
      <div
        data-agent-ui="StreamingText"
        className={`beautiful-ui nex-ui-StreamingText ${props.className ?? ""}`}
      >
        {props.children}
      </div>
    );
  return <StreamingTextPreview {...props} />;
}

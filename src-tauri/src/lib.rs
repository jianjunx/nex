...
pub fn run() {
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::project_cmds::conversation_update_agent,
            ...
            commands::agent_cmds::agent_steer,
            commands::agent_cmds::agent_set_goal,
            commands::agent_cmds::agent_get_session_state,
            ...
            commands::agent_cmds::native_agent_fork_session,
            commands::agent_cmds::native_agent_history_page,

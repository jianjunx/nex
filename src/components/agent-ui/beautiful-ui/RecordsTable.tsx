...
function ConfigPicker({
  ...
  return (
    ...
    >
      <div className="px-2 pb-1 pt-0.5 text-[11.5px] font-medium text-ink-3">
        {label}
      </div>
  ...
  return (
    <div className={`records-shell${fill ? " is-fill" : ""}`}>
      ...
      {prop && meta && (
        ...
        >
          <div className="pb-2 text-[13.5px] font-medium text-ink">
            {prop.col}
          </div>
          ...
          <ConfigRow label="Tool">
            ...
            >
              <span
                className={
                  meta.toolKind === "model" ? "text-accent" : "text-ink-2"
                }
              >
                {meta.toolKind === "model" ? (
                  <svg
          ...
          >
            ...
            >
              <span
                className={
                  pinnedColumns.has(prop.col) ? "text-accent" : "text-ink-2"
                }
              >
                <Icon size={15}>
          ...
          {moreSettingsOpen && (
            ...
            >
              <div className="pb-1 text-[11.5px] font-medium text-ink-3">
                Behavior
              </div>
      ...
      {addOpen && (
        ...
        >
          <div className="px-2 pb-1 pt-1 text-[12px] font-medium text-ink-3">
            New property
          </div>
          <GlideMenu className="flex flex-col gap-px">
...
export default function RecordsTable(
  props: NonNullable<Parameters<typeof RecordsTablePreview>[0]> & {
  ...
  if (props.children !== undefined)
    return (
      <div
        data-agent-ui="RecordsTable"
        className={`beautiful-ui nex-ui-RecordsTable ${props.className ?? ""}`}
      >
        {props.children}
      </div>
    );
  return <RecordsTablePreview {...props} />;
}

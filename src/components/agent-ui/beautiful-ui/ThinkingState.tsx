...
export default function ThinkingState(
  props: NonNullable<Parameters<typeof ThinkingStatePreview>[0]> & {
  ...
  if (props.children !== undefined)
    return (
      <div
        data-agent-ui="ThinkingState"
        className={`beautiful-ui nex-ui-ThinkingState ${props.className ?? ""}`}
      >
        {props.children}
      </div>
    );
  return <ThinkingStatePreview {...props} />;
}

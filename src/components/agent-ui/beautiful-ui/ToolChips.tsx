...
export default function ToolChips(
  props: NonNullable<Parameters<typeof ToolChipsPreview>[0]> & {
  ...
  if (props.children !== undefined)
    return (
      <div
        data-agent-ui="ToolChips"
        className={`beautiful-ui nex-ui-ToolChips ${props.className ?? ""}`}
      >
        {props.children}
      </div>
    );
  return <ToolChipsPreview {...props} />;
}

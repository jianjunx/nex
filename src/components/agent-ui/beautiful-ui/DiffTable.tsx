...
import { Button } from "@/components/agent-ui/atoms/Button";
              ...
              return (
                ...
                >
                  ...
                  <td className="primitive-table-cell">
                    ...
                    >
                      <span
                        className={`size-1.5 rounded-full ${DOT[row.dept]}`}
                      />
                ...
                >
                  <div className="overflow-hidden">
                    <div
                      ...
                      onClick={
                        accepted ? undefined : () => toggleEdit("pistachio")
                      }
                      onKeyDown={
                        accepted
                          ? undefined
                      ...
                      className={`grid grid-cols-[34%_30%_36%] items-center border-t border-line transition-[background-color,filter,opacity] duration-150 focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-inset focus-visible:ring-accent ${
                        accepted
                          ? ""
                          : "cursor-pointer hover:brightness-[0.985]"
                      }`}
                      style={{
                        background: edits.pistachio
                          ? "var(--green-tint)"
                          : undefined,
                      }}
                    >
          ...
          >
            {accepted ? (
              ...
              >
                ...
                {removals + additions}{" "}
                {removals + additions === 1 ? "edit" : "edits"} applied
              </span>
            ) : (
              <>
...
export default function DiffTable(
  props: NonNullable<Parameters<typeof DiffTablePreview>[0]> & {
  ...
  if (props.children !== undefined)
    return (
      <div
        data-agent-ui="DiffTable"
        className={`beautiful-ui nex-ui-DiffTable ${props.className ?? ""}`}
      >
        {props.children}
      </div>
    );
  return <DiffTablePreview {...props} />;
}

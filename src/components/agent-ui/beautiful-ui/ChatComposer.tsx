...
export default function ChatComposer(
  props: NonNullable<Parameters<typeof ChatComposerPreview>[0]> & {
  ...
  if (props.children !== undefined)
    return (
      <div
        data-agent-ui="ChatComposer"
        className={`beautiful-ui nex-ui-ChatComposer ${props.className ?? ""}`}
      >
        {props.children}
      </div>
    );
  return <ChatComposerPreview {...props} />;
}

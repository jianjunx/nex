...
export default function SearchList(
  props: NonNullable<Parameters<typeof SearchListPreview>[0]> & {
  ...
  if (props.children !== undefined)
    return (
      <div
        data-agent-ui="Search"
        className={`beautiful-ui nex-ui-Search ${props.className ?? ""}`}
      >
        {props.children}
      </div>
    );
  return <SearchListPreview {...props} />;
}

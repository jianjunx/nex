...
export const COMMANDS = {
  ...
  CONVERSATION_UPDATE_AGENT: "conversation_update_agent",
  ...
  AGENT_GET_SESSION_STATE: "agent_get_session_state",
  ...
  NATIVE_AGENT_FORK_SESSION: "native_agent_fork_session",
  NATIVE_AGENT_HISTORY_PAGE: "native_agent_history_page",

...
/** Pending image attachment shape accepted by the composer. Image bytes stay in
 * in-memory drafts so project/tab switches can restore unsent attachments. */
...
/** Persist (or clear) text/mentions/images for a conversation tab in memory so
 * project/tab switches can restore unsent composer state. */

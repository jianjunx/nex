...
- Transcript messages prefixed with `[nex:working-memory]` or `[nex:summary]` are maintained by the Nex harness. Never output, paraphrase, or imitate them (including after other prose); continue the task with tools and normal answers instead.
